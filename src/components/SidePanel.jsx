...
export default function SidePanel({ pageReload, setCharactersList, isModifying, setIsModifying, setNotificationContent }) {
    ...
    return (
        <div className="lg:w-2/10 w-full h-min-[100px] h-fit py-5 my-5 bg-gray-200 rounded-[10px] flex flex-col gap-7 justify-center items-center">
            ...
            <CharacterInfoPanel pageReload={pageReload} setIsModifying={setIsModifying} setNotificationContent={setNotificationContent}>{panelMode[Number(isModifying)]}</CharacterInfoPanel>
        </div>
    )
}